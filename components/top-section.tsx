    ...
    <section className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
      <div>
        ...
        <p className="text-sm leading-relaxed">
          After Image is a software development studio specializing in innovative digital solutions. 
      ...
      <div>
        ...
        <p className="text-sm leading-relaxed">
          At After Image, we're building cutting-edge software solutions and interactive experiences. 
